...
public interface TxRepository extends JpaRepository<Transaction, Long> , PagingAndSortingRepository<Transaction, Long>, JpaSpecificationExecutor<Transaction> {
	...
	List<Transaction> findByMerchantIdAndTxDateBetweenOrderByTxDateDesc(String marchantId, LocalDate startDate, LocalDate endDate);
	...
	Transaction findByUtrNumberAndTxType(String utrNumber, String txType);
