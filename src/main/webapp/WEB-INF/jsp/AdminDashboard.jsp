									...
									<div class="panel-body bio-graph-info">
										...
										<div class="panel panel-primary">
											<div class="panel-heading" style="background-color: #60b51a;"
												align="center">
												<strong> <font
													style="color: white; cursor: pointer;">Dashboard</font>
										...
										<div style="margin-top: -20px;">
											<div class="panel-heading"
												...
												<strong> <a href="#"> <font	style="color: white; cursor: pointer;">1. Client Onboarding </font>
										...
										<div class="panel-heading"
											style="background-color: #002066; margin: 1px 0 1px 0px; border-radius: 0px;">
											<strong> <a href="/api/v1/fe/AccountStatement"> <font
													style="color: white; cursor: pointer;">2. Product Featuring  </font>
										...
										<div>
											<div class="panel-heading"
												...
												<strong> <a href="/api/v1/fe/payoutReport"> <font
														style="color: white; cursor: pointer;">3. Sub Admin Account </font> 
										...
										<div>
											<div class="panel-heading"
												...
												<strong> <a href="/api/v1/fe/AccessSetting"> <font
														style="color: white; cursor: pointer;">4. Report </font> 
										...
										<div>
											<div class="panel-heading"
												...
												<strong> <a href="/api/v1/fe/Setting"> <font
														style="color: white; cursor: pointer;">5. Setting</font> 
