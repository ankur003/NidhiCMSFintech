								...
								<div class="mu-contact-left">
									...
									<div class="panel-body bio-graph-info">
										...
										<div style="margin-top: -20px;">
											<div class="panel-heading"
												...
												<strong> <a href="/api/v1/fe/Dashboard"> <font
														style="color: white; cursor: pointer;">1. Dashborad</font></a></strong>
											</div>
										</div>
										<div class="panel-heading"
											style="background-color: #002066; margin: 1px 0 1px 0px; border-radius: 0px;">
											<strong> <a href="#"> <font
													style="color: white; cursor: pointer;">2. Payout
														Report </font> <img src="/assets/img/rightbluearrow.png"
													align="right"
										...
										<div>
											<div class="panel-heading"
												style="background-color: #002066; margin: 1px 0 1px 0px; border-radius: 0px;">
												<strong> <a href="/api/v1/fe/bankAcVerifyreport"> <font
														style="color: white; cursor: pointer;">3. Bank A/c
															Verification</font>
									...
									<form class="contactform">
										...
										<div class="col-sm-12">
											<p class="comment-form-comment">
												<label for="comment">Payout Report</label>
											</p>
										</div>
