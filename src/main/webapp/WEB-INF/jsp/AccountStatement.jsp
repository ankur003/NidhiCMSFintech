									...
									<div class="panel-body bio-graph-info">
										...
										<div style="margin-top: -20px;">
											<div class="panel-heading"
												...
												<strong> <a href="/api/v1/fe/Dashboard"> <font
														style="color: white; cursor: pointer;">1. Summary</font></a></strong>
											</div>
										</div>
										<div class="panel-heading"
											style="background-color: #002066; margin: 1px 0 1px 0px; border-radius: 0px;">
											<strong> <a href="#"> <font
													style="color: white; cursor: pointer;">2. Account
														Statement </font> <img src="/assets/img/rightbluearrow.png"
													align="right"
										...
										<div>
											<div class="panel-heading"
												...
												<strong> <a href="/api/v1/fe/AccessSetting"> <font
														style="color: white; cursor: pointer;">4. Access Setting</font> 
										...
										<div>
											<div class="panel-heading"
												style="background-color: #002066; margin: 1px 0 1px 0px; border-radius: 0px;">
												<strong> <a href="/api/v1/fe/FundAccount"> <font
														style="color: white; cursor: pointer;">5. Fund Account</font> 
